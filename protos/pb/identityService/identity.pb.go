...
type SetDevicePreferenceRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	DevicePreferenceType string `protobuf:"bytes,3,opt,name=devicePreferenceType,proto3" json:"devicePreferenceType,omitempty"`
	Status               bool   `protobuf:"varint,4,opt,name=status,proto3" json:"status,omitempty"`
}

func (x *SetDevicePreferenceRequest) Reset() {
	*x = SetDevicePreferenceRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *SetDevicePreferenceRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SetDevicePreferenceRequest) ProtoMessage() {}

func (x *SetDevicePreferenceRequest) ProtoReflect() protoreflect.Message {
	mi := &file_identity_proto_msgTypes[7]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SetDevicePreferenceRequest.ProtoReflect.Descriptor instead.
func (*SetDevicePreferenceRequest) Descriptor() ([]byte, []int) {
	return file_identity_proto_rawDescGZIP(), []int{7}
}

func (x *SetDevicePreferenceRequest) GetIdentityId() string {
	if x != nil {
		return x.IdentityId
	}
	return ""
...
func (x *SetDevicePreferenceRequest) GetDeviceId() string {
	if x != nil {
		return x.DeviceId
	}
	return ""
...
func (x *SetDevicePreferenceRequest) GetDevicePreferenceType() string {
	if x != nil {
		return x.DevicePreferenceType
	}
	return ""
}

func (x *SetDevicePreferenceRequest) GetStatus() bool {
	if x != nil {
		return x.Status
	}
	return false
...
var file_identity_proto_rawDesc = []byte{
	...
	0x50, 0x61, 0x73, 0x73, 0x63, 0x6f, 0x64, 0x65, 0x22, 0xa4, 0x01, 0x0a, 0x1a, 0x53, 0x65, 0x74,
	...
	0x65, 0x49, 0x64, 0x12, 0x32, 0x0a, 0x14, 0x64, 0x65, 0x76, 0x69, 0x63, 0x65, 0x50, 0x72, 0x65,
	0x66, 0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x54, 0x79, 0x70, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x14, 0x64, 0x65, 0x76, 0x69, 0x63, 0x65, 0x50, 0x72, 0x65, 0x66, 0x65, 0x72, 0x65,
	...
	,
	...
	0x6f, 0x72, 0x64, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x0f, 0x2e, 0x74, 0x79, 0x70,
	0x65, 0x73, 0x2e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x66, 0x0a,
	0x1f, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x52, 0x65, 0x73, 0x65, 0x74, 0x54, 0x72, 0x61,
	0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x50, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64,
	0x12, 0x30, 0x2e, 0x69, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x2e, 0x52, 0x65, 0x71, 0x75,
	0x65, 0x73, 0x74, 0x52, 0x65, 0x73, 0x65, 0x74, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74,
	...
	,
...
var file_identity_proto_goTypes = []interface{}{
	...
	(*SetDevicePreferenceRequest)(nil),             // 7: identity.SetDevicePreferenceRequest
...
var file_identity_proto_depIdxs = []int32{
	...
	7, // 5: identity.identityService.SetDevicePreference:input_type -> identity.SetDevicePreferenceRequest
	8, // 6: identity.identityService.updateDeviceTokens:output_type -> types.Response
	8, // 7: identity.identityService.CreateTransactionPassword:output_type -> types.Response
	8, // 8: identity.identityService.RequestResetTransactionPassword:output_type -> types.Response
	8, // 9: identity.identityService.ResetTransactionPassword:output_type -> types.Response
	8, // 10: identity.identityService.SetDevicePreference:output_type -> types.Response
...
func file_identity_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_identity_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SetDevicePreferenceRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
...
type IdentityServiceClient interface {
	...
	SetDevicePreference(ctx context.Context, in *SetDevicePreferenceRequest, opts ...grpc.CallOption) (*types.Response, error)
}
...
func (c *identityServiceClient) SetDevicePreference(ctx context.Context, in *SetDevicePreferenceRequest, opts ...grpc.CallOption) (*types.Response, error) {
	out := new(types.Response)
	err := c.cc.Invoke(ctx, "/identity.identityService/SetDevicePreference", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type IdentityServiceServer interface {
	...
	SetDevicePreference(context.Context, *SetDevicePreferenceRequest) (*types.Response, error)
}
...
func (*UnimplementedIdentityServiceServer) SetDevicePreference(context.Context, *SetDevicePreferenceRequest) (*types.Response, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SetDevicePreference not implemented")
}
...
func _IdentityService_SetDevicePreference_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SetDevicePreferenceRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(IdentityServiceServer).SetDevicePreference(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/identity.identityService/SetDevicePreference",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(IdentityServiceServer).SetDevicePreference(ctx, req.(*SetDevicePreferenceRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _IdentityService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "SetDevicePreference",
			Handler:    _IdentityService_SetDevicePreference_Handler,
		},
	},
