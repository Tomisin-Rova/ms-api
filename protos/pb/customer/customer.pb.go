...
//*
// Represents get staff auidit logs response.
...
var file_customer_proto_rawDesc = []byte{
	...
	0xf2, 0x0f, 0x0a, 0x0f, 0x43, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x65, 0x72, 0x53, 0x65, 0x72, 0x76,
	0x69, 0x63, 0x65, 0x12, 0x51, 0x0a, 0x12, 0x52, 0x65, 0x73, 0x65, 0x74, 0x4c, 0x6f, 0x67, 0x69,
	0x6e, 0x50, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x12, 0x23, 0x2e, 0x63, 0x75, 0x73, 0x74,
	0x6f, 0x6d, 0x65, 0x72, 0x2e, 0x52, 0x65, 0x73, 0x65, 0x74, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x50,
	...
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x51, 0x0a, 0x12, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x43,
	0x75, 0x73, 0x74, 0x6f, 0x6d, 0x65, 0x72, 0x45, 0x6d, 0x61, 0x69, 0x6c, 0x12, 0x23, 0x2e, 0x63,
	...
	0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x4f, 0x0a, 0x11, 0x43, 0x68, 0x65,
	0x63, 0x6b, 0x43, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x65, 0x72, 0x44, 0x61, 0x74, 0x61, 0x12, 0x22,
	...
	0x6c, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x57, 0x0a, 0x15, 0x43, 0x75,
	0x73, 0x74, 0x6f, 0x6d, 0x65, 0x72, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x73, 0x55, 0x70, 0x64,
	0x61, 0x74, 0x65, 0x12, 0x26, 0x2e, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x65, 0x72, 0x2e, 0x43,
...
var file_customer_proto_goTypes = []interface{}{
	...
	(*GetStaffAuditLogsRequest)(nil),                        // 34: customer.GetStaffAuditLogsRequest
	(*GetStaffAuditLogsResponse)(nil),                       // 35: customer.GetStaffAuditLogsResponse
	(*types.DeviceInput)(nil),                               // 36: types.DeviceInput
	(types.Customer_CustomerTitle)(0),                       // 37: types.Customer.CustomerTitle
	(*types.DeviceTokenInput)(nil),                          // 38: types.DeviceTokenInput
	(*types.DevicePreferencesInput)(nil),                    // 39: types.DevicePreferencesInput
	(*types.Customer)(nil),                                  // 40: types.Customer
	(*types.Staff)(nil),                                     // 41: types.Staff
	(types.Customer_CustomerStatuses)(0),                    // 42: types.Customer.CustomerStatuses
	(*types.PaginationInfo)(nil),                            // 43: types.PaginationInfo
	(*types.Content)(nil),                                   // 44: types.Content
	(types.Questionary_QuestionaryStatuses)(0),              // 45: types.Questionary.QuestionaryStatuses
	(types.Questionary_QuestionaryTypes)(0),                 // 46: types.Questionary.QuestionaryTypes
	(*types.Questionary)(nil),                               // 47: types.Questionary
	(*types.Address)(nil),                                   // 48: types.Address
	(*types.Country)(nil),                                   // 49: types.Country
	(types.IdentityCredentials_IdentityCredentialsTypes)(0), // 50: types.IdentityCredentials.IdentityCredentialsTypes
	(*types.StaffAuditLog)(nil),                             // 51: types.StaffAuditLog
	(*types.DefaultResponse)(nil),                           // 52: types.DefaultResponse
	(*types.Device)(nil),                                    // 53: types.Device
}
var file_customer_proto_depIdxs = []int32{
	36, // 0: customer.CheckCustomerEmailRequest.device:type_name -> types.DeviceInput
	...
	37, // 3: customer.RegisterRequest.title:type_name -> types.Customer.CustomerTitle
	6,  // 4: customer.AddressInput.cordinates:type_name -> customer.CordinatesInput
	38, // 5: customer.SetDeviceTokenRequest.tokens:type_name -> types.DeviceTokenInput
	39, // 6: customer.SetDevicePreferencesRequest.preferences:type_name -> types.DevicePreferencesInput
	40, // 7: customer.MeResponse.customer:type_name -> types.Customer
	41, // 8: customer.MeResponse.staff:type_name -> types.Staff
	42, // 9: customer.GetCustomersRequest.statuses:type_name -> types.Customer.CustomerStatuses
	40, // 10: customer.GetCustomersResponse.nodes:type_name -> types.Customer
	43, // 11: customer.GetCustomersResponse.pagination_info:type_name -> types.PaginationInfo
	44, // 12: customer.GetContentsResponse.nodes:type_name -> types.Content
	43, // 13: customer.GetContentsResponse.pagination_info:type_name -> types.PaginationInfo
	45, // 14: customer.GetQuestionariesRequest.statuses:type_name -> types.Questionary.QuestionaryStatuses
	46, // 15: customer.GetQuestionariesRequest.types:type_name -> types.Questionary.QuestionaryTypes
	47, // 16: customer.GetQuestionariesResponse.nodes:type_name -> types.Questionary
	43, // 17: customer.GetQuestionariesResponse.pagination_info:type_name -> types.PaginationInfo
	28, // 18: customer.AnswerQuestionaryRequest.answers:type_name -> customer.AnswerInput
	48, // 19: customer.GetAddressesResponse.nodes:type_name -> types.Address
	43, // 20: customer.GetAddressesResponse.pagination_info:type_name -> types.PaginationInfo
	49, // 21: customer.GetCountriesResponse.nodes:type_name -> types.Country
	43, // 22: customer.GetCountriesResponse.pagination_info:type_name -> types.PaginationInfo
	50, // 23: customer.DeactivateCredentialRequest.credential_type:type_name -> types.IdentityCredentials.IdentityCredentialsTypes
	51, // 24: customer.GetStaffAuditLogsResponse.nodes:type_name -> types.StaffAuditLog
	43, // 25: customer.GetStaffAuditLogsResponse.pagination_info:type_name -> types.PaginationInfo
	0,  // 26: customer.CustomerService.ResetLoginPassword:input_type -> customer.ResetLoginPasswordRequest
	1,  // 27: customer.CustomerService.CheckCustomerEmail:input_type -> customer.CheckCustomerEmailRequest
	2,  // 28: customer.CustomerService.CheckCustomerData:input_type -> customer.CheckCustomerDataRequest
	3,  // 29: customer.CustomerService.CustomerDetailsUpdate:input_type -> customer.CustomerDetailsUpdateRequest
	4,  // 30: customer.CustomerService.Register:input_type -> customer.RegisterRequest
	7,  // 31: customer.CustomerService.SetTransactionPassword:input_type -> customer.SetTransactionPasswordRequest
	8,  // 32: customer.CustomerService.ForgotTransactionPassword:input_type -> customer.ForgotTransactionPasswordRequest
	9,  // 33: customer.CustomerService.ResetTransactionPassword:input_type -> customer.ResetTransactionPasswordRequest
	10, // 34: customer.CustomerService.SetDeviceToken:input_type -> customer.SetDeviceTokenRequest
	11, // 35: customer.CustomerService.SetDevicePreferences:input_type -> customer.SetDevicePreferencesRequest
	12, // 36: customer.CustomerService.CheckBVN:input_type -> customer.CheckBVNRequest
	13, // 37: customer.CustomerService.CheckEmail:input_type -> customer.CheckEmailRequest
	14, // 38: customer.CustomerService.CheckPhoneNumber:input_type -> customer.CheckPhoneNumberRequest
	15, // 39: customer.CustomerService.Me:input_type -> customer.MeRequest
	17, // 40: customer.CustomerService.GetCustomer:input_type -> customer.GetCustomerRequest
	18, // 41: customer.CustomerService.GetCustomers:input_type -> customer.GetCustomersRequest
	20, // 42: customer.CustomerService.GetContent:input_type -> customer.GetContentRequest
	21, // 43: customer.CustomerService.GetContents:input_type -> customer.GetContentsRequest
	23, // 44: customer.CustomerService.SetAcceptance:input_type -> customer.SetAcceptanceRequest
	24, // 45: customer.CustomerService.GetQuestionary:input_type -> customer.GetQuestionaryRequest
	25, // 46: customer.CustomerService.GetQuestionaries:input_type -> customer.GetQuestionariesRequest
	27, // 47: customer.CustomerService.AnswerQuestionary:input_type -> customer.AnswerQuestionaryRequest
	29, // 48: customer.CustomerService.GetAddresses:input_type -> customer.GetAddressesRequest
	31, // 49: customer.CustomerService.GetCountries:input_type -> customer.GetCountriesRequest
	33, // 50: customer.CustomerService.DeactivateCredential:input_type -> customer.DeactivateCredentialRequest
	34, // 51: customer.CustomerService.GetStaffAuditLogs:input_type -> customer.GetStaffAuditLogsRequest
	52, // 52: customer.CustomerService.ResetLoginPassword:output_type -> types.DefaultResponse
	52, // 53: customer.CustomerService.CheckCustomerEmail:output_type -> types.DefaultResponse
	52, // 54: customer.CustomerService.CheckCustomerData:output_type -> types.DefaultResponse
	52, // 55: customer.CustomerService.CustomerDetailsUpdate:output_type -> types.DefaultResponse
	40, // 56: customer.CustomerService.Register:output_type -> types.Customer
	52, // 57: customer.CustomerService.SetTransactionPassword:output_type -> types.DefaultResponse
	52, // 58: customer.CustomerService.ForgotTransactionPassword:output_type -> types.DefaultResponse
	52, // 59: customer.CustomerService.ResetTransactionPassword:output_type -> types.DefaultResponse
	52, // 60: customer.CustomerService.SetDeviceToken:output_type -> types.DefaultResponse
	53, // 61: customer.CustomerService.SetDevicePreferences:output_type -> types.Device
	52, // 62: customer.CustomerService.CheckBVN:output_type -> types.DefaultResponse
	52, // 63: customer.CustomerService.CheckEmail:output_type -> types.DefaultResponse
	52, // 64: customer.CustomerService.CheckPhoneNumber:output_type -> types.DefaultResponse
	16, // 65: customer.CustomerService.Me:output_type -> customer.MeResponse
	40, // 66: customer.CustomerService.GetCustomer:output_type -> types.Customer
	19, // 67: customer.CustomerService.GetCustomers:output_type -> customer.GetCustomersResponse
	44, // 68: customer.CustomerService.GetContent:output_type -> types.Content
	22, // 69: customer.CustomerService.GetContents:output_type -> customer.GetContentsResponse
	52, // 70: customer.CustomerService.SetAcceptance:output_type -> types.DefaultResponse
	47, // 71: customer.CustomerService.GetQuestionary:output_type -> types.Questionary
	26, // 72: customer.CustomerService.GetQuestionaries:output_type -> customer.GetQuestionariesResponse
	52, // 73: customer.CustomerService.AnswerQuestionary:output_type -> types.DefaultResponse
	30, // 74: customer.CustomerService.GetAddresses:output_type -> customer.GetAddressesResponse
	32, // 75: customer.CustomerService.GetCountries:output_type -> customer.GetCountriesResponse
	52, // 76: customer.CustomerService.DeactivateCredential:output_type -> types.DefaultResponse
	35, // 77: customer.CustomerService.GetStaffAuditLogs:output_type -> customer.GetStaffAuditLogsResponse
