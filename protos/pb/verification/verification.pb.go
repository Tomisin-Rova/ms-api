...
const (
	RequestOTPRequest_EMAIL RequestOTPRequest_DeliveryMode = 0 //* Email delivery mode.
	RequestOTPRequest_SMS   RequestOTPRequest_DeliveryMode = 1 //* SMS delivery mode.
	RequestOTPRequest_PUSH  RequestOTPRequest_DeliveryMode = 2 //* In App push notification delivery mode.
)
...
//*
// Represents request otp request.
type RequestOTPRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Type                RequestOTPRequest_DeliveryMode `protobuf:"varint,1,opt,name=type,proto3,enum=verification.RequestOTPRequest_DeliveryMode" json:"type,omitempty"` //* Delivery mode for the otp.
	Target              string                         `protobuf:"bytes,2,opt,name=target,proto3" json:"target,omitempty"`                                               /// The target of the otp
	ExpireTimeInSeconds int32                          `protobuf:"varint,3,opt,name=expireTimeInSeconds,proto3" json:"expireTimeInSeconds,omitempty"`                    /// The expiration time in seconds.
}
...
//*
// Represents verify otp request.
type VerifyOTPRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Target   string `protobuf:"bytes,1,opt,name=target,proto3" json:"target,omitempty"`                     /// The target of the otp.
	OtpToken string `protobuf:"bytes,2,opt,name=otp_token,json=otpToken,proto3" json:"otp_token,omitempty"` /// The otp.
}
...
type VerificationServiceClient interface {
	/// Used to request otp. Pass in a RequestOTPRequest and a DefaultResponse(success and code) would be returned.
	RequestOTP(ctx context.Context, in *RequestOTPRequest, opts ...grpc.CallOption) (*types.DefaultResponse, error)
	/// Used to verify otp. Pass in a VerifyOTPRequest and a DefaultResponse(success and code) would be returned.
