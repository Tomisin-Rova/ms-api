...
var file_payment_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xe5, 0x01, 0x0a, 0x0f, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x66,
	...
	0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x50, 0x69, 0x6e, 0x32, 0x4d, 0x0a,
	0x0e, 0x50, 0x61, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12,
	0x3b, 0x0a, 0x0c, 0x4d, 0x61, 0x6b, 0x65, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x66, 0x65, 0x72, 0x12,
...
var file_payment_proto_goTypes = []interface{}{
	(*TransferRequest)(nil), // 0: payment.TransferRequest
	(*types.Response)(nil),  // 1: types.Response
}
var file_payment_proto_depIdxs = []int32{
	0, // 0: payment.PaymentService.MakeTransfer:input_type -> payment.TransferRequest
	1, // 1: payment.PaymentService.MakeTransfer:output_type -> types.Response
...
type PaymentServiceClient interface {
	MakeTransfer(ctx context.Context, in *TransferRequest, opts ...grpc.CallOption) (*types.Response, error)
}
...
func (c *paymentServiceClient) MakeTransfer(ctx context.Context, in *TransferRequest, opts ...grpc.CallOption) (*types.Response, error) {
...
type PaymentServiceServer interface {
	MakeTransfer(context.Context, *TransferRequest) (*types.Response, error)
}
...
func (*UnimplementedPaymentServiceServer) MakeTransfer(context.Context, *TransferRequest) (*types.Response, error) {
