...
type PersonServiceClient interface {
	...
	People(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*types.Persons, error)
	// M U T A T I O N S
...
func (c *personServiceClient) People(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*types.Persons, error) {
...
type PersonServiceServer interface {
	...
	People(context.Context, *empty.Empty) (*types.Persons, error)
	// M U T A T I O N S
...
func (*UnimplementedPersonServiceServer) People(context.Context, *empty.Empty) (*types.Persons, error) {
...
func _PersonService_People_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PersonServiceServer).People(ctx, req.(*empty.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
