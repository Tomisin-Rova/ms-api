...
//*
// Staff login auth type.
type StaffLoginRequest_AuthType int32

const (
	StaffLoginRequest_GOOGLE StaffLoginRequest_AuthType = 0 //* Google auth type.
)
...
//*
// Represents signup request.
type SignupRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	CustomerInput *CustomerInput     `protobuf:"bytes,1,opt,name=customer_input,json=customerInput,proto3" json:"customer_input,omitempty"` /// Customer inputs
...
//*
// Represents customer input.
type CustomerInput struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Phone         string `protobuf:"bytes,1,opt,name=phone,proto3" json:"phone,omitempty"`                                      /// Customer phone number.
	Email         string `protobuf:"bytes,2,opt,name=email,proto3" json:"email,omitempty"`                                      /// Customer email address.
	LoginPassword string `protobuf:"bytes,3,opt,name=login_password,json=loginPassword,proto3" json:"login_password,omitempty"` /// Customer login password.
}
...
//*
// Represents token pair response.
type TokenPairResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	AuthToken    string `protobuf:"bytes,1,opt,name=auth_token,json=authToken,proto3" json:"auth_token,omitempty"`          /// Customer auth token.
	RefreshToken string `protobuf:"bytes,2,opt,name=refresh_token,json=refreshToken,proto3" json:"refresh_token,omitempty"` /// Customer refresh token.
}
...
type RefreshTokenRequest struct {
	...
	Token string `protobuf:"bytes,1,opt,name=token,proto3" json:"token,omitempty"` /// Token you want to refresh.
}
...
//*
// Represents Staff login request.
type StaffLoginRequest struct {
	...
	AuthType StaffLoginRequest_AuthType `protobuf:"varint,2,opt,name=auth_type,json=authType,proto3,enum=auth.StaffLoginRequest_AuthType" json:"auth_type,omitempty"` //* Auth type for the login request.
}
...
//*
// Represents validate token request.
type ValidateTokenRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Token string `protobuf:"bytes,1,opt,name=token,proto3" json:"token,omitempty"` /// Token of the customer.
}
...
//*
// Represents validate token response.
type ValidateTokenResponse struct {
	...
	Claims  *types.JWTClaims `protobuf:"bytes,2,opt,name=claims,proto3" json:"claims,omitempty"` /// Customer claims(details).
}
...
//*
// Represents validate transaction pin request.
type ValidateTransactionPinRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	TransactionPin string `protobuf:"bytes,1,opt,name=transaction_pin,json=transactionPin,proto3" json:"transaction_pin,omitempty"`
}

func (x *ValidateTransactionPinRequest) Reset() {
	*x = ValidateTransactionPinRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *ValidateTransactionPinRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ValidateTransactionPinRequest) ProtoMessage() {}

func (x *ValidateTransactionPinRequest) ProtoReflect() protoreflect.Message {
	mi := &file_auth_proto_msgTypes[8]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ValidateTransactionPinRequest.ProtoReflect.Descriptor instead.
func (*ValidateTransactionPinRequest) Descriptor() ([]byte, []int) {
	return file_auth_proto_rawDescGZIP(), []int{8}
}

func (x *ValidateTransactionPinRequest) GetTransactionPin() string {
	if x != nil {
...
var file_auth_proto_rawDesc = []byte{
	...
	0x73, 0x52, 0x06, 0x63, 0x6c, 0x61, 0x69, 0x6d, 0x73, 0x22, 0x48, 0x0a, 0x1d, 0x56, 0x61, 0x6c,
	0x69, 0x64, 0x61, 0x74, 0x65, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e,
	0x50, 0x69, 0x6e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x27, 0x0a, 0x0f, 0x74, 0x72,
	0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x70, 0x69, 0x6e, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x0e, 0x74, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e,
	0x50, 0x69, 0x6e, 0x32, 0xa0, 0x03, 0x0a, 0x0b, 0x41, 0x75, 0x74, 0x68, 0x53, 0x65, 0x72, 0x76,
	0x69, 0x63, 0x65, 0x12, 0x36, 0x0a, 0x06, 0x53, 0x69, 0x67, 0x6e, 0x75, 0x70, 0x12, 0x13, 0x2e,
	...
	0x61, 0x69, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x34, 0x0a, 0x05, 0x4c,
	...
	0x65, 0x12, 0x3e, 0x0a, 0x0a, 0x53, 0x74, 0x61, 0x66, 0x66, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x12,
	0x17, 0x2e, 0x61, 0x75, 0x74, 0x68, 0x2e, 0x53, 0x74, 0x61, 0x66, 0x66, 0x4c, 0x6f, 0x67, 0x69,
	0x6e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x17, 0x2e, 0x61, 0x75, 0x74, 0x68, 0x2e,
	0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x50, 0x61, 0x69, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73,
	...
	0x75, 0x74, 0x68, 0x2e, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x50, 0x61, 0x69, 0x72, 0x52, 0x65, 0x73,
	...
	0x55, 0x0a, 0x16, 0x56, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x65, 0x54, 0x72, 0x61, 0x6e, 0x73,
	0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x50, 0x69, 0x6e, 0x12, 0x23, 0x2e, 0x61, 0x75, 0x74, 0x68,
	0x2e, 0x56, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x65, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63,
	0x74, 0x69, 0x6f, 0x6e, 0x50, 0x69, 0x6e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x16,
	0x2e, 0x74, 0x79, 0x70, 0x65, 0x73, 0x2e, 0x44, 0x65, 0x66, 0x61, 0x75, 0x6c, 0x74, 0x52, 0x65,
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x17, 0x5a, 0x15, 0x6d, 0x73, 0x2e, 0x61, 0x70, 0x69,
	0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x73, 0x2f, 0x70, 0x62, 0x2f, 0x61, 0x75, 0x74, 0x68, 0x62,
...
var file_auth_proto_goTypes = []interface{}{
	...
	(*ValidateTransactionPinRequest)(nil), // 9: auth.ValidateTransactionPinRequest
	(*types.DeviceInput)(nil),             // 10: types.DeviceInput
	(*types.JWTClaims)(nil),               // 11: types.JWTClaims
	(*types.DefaultResponse)(nil),         // 12: types.DefaultResponse
}
var file_auth_proto_depIdxs = []int32{
	2,  // 0: auth.SignupRequest.customer_input:type_name -> auth.CustomerInput
	10, // 1: auth.SignupRequest.device:type_name -> types.DeviceInput
	2,  // 2: auth.LoginRequest.customer_input:type_name -> auth.CustomerInput
	10, // 3: auth.LoginRequest.device:type_name -> types.DeviceInput
	0,  // 4: auth.StaffLoginRequest.auth_type:type_name -> auth.StaffLoginRequest.AuthType
	11, // 5: auth.ValidateTokenResponse.claims:type_name -> types.JWTClaims
	...
	9,  // 11: auth.AuthService.ValidateTransactionPin:input_type -> auth.ValidateTransactionPinRequest
	3,  // 12: auth.AuthService.Signup:output_type -> auth.TokenPairResponse
	3,  // 13: auth.AuthService.Login:output_type -> auth.TokenPairResponse
	3,  // 14: auth.AuthService.StaffLogin:output_type -> auth.TokenPairResponse
	3,  // 15: auth.AuthService.RefreshToken:output_type -> auth.TokenPairResponse
	8,  // 16: auth.AuthService.ValidateToken:output_type -> auth.ValidateTokenResponse
	12, // 17: auth.AuthService.ValidateTransactionPin:output_type -> types.DefaultResponse
...
func file_auth_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_auth_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ValidateTransactionPinRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
...
type AuthServiceClient interface {
	/// Used to signup a customer. Pass in a SignupRequest and a TokenPairResponse would be returned.
	Signup(ctx context.Context, in *SignupRequest, opts ...grpc.CallOption) (*TokenPairResponse, error)
	/// Used to login a customer. Pass in LoginRequest and a TokenPairResponse would be returned.
	Login(ctx context.Context, in *LoginRequest, opts ...grpc.CallOption) (*TokenPairResponse, error)
	/// Used to login a staff. Pass in StaffLoginRequest and a TokenPairResponse would be returned.
	StaffLogin(ctx context.Context, in *StaffLoginRequest, opts ...grpc.CallOption) (*TokenPairResponse, error)
	/// Used to refresh token. Pass in a RefreshTokenRequest and a TokenPairResponse would be returned.
	RefreshToken(ctx context.Context, in *RefreshTokenRequest, opts ...grpc.CallOption) (*TokenPairResponse, error)
	/// Used to validate token. Pass in a ValidateTokenRequest and a ValidateTokenResponse would be returned.
	ValidateToken(ctx context.Context, in *ValidateTokenRequest, opts ...grpc.CallOption) (*ValidateTokenResponse, error)
	/// Used to validate transaction pin. Pass in a ValidateTransactionPinRequest and the default response would be returned
	ValidateTransactionPin(ctx context.Context, in *ValidateTransactionPinRequest, opts ...grpc.CallOption) (*types.DefaultResponse, error)
}
...
func (c *authServiceClient) ValidateTransactionPin(ctx context.Context, in *ValidateTransactionPinRequest, opts ...grpc.CallOption) (*types.DefaultResponse, error) {
	out := new(types.DefaultResponse)
	err := c.cc.Invoke(ctx, "/auth.AuthService/ValidateTransactionPin", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AuthServiceServer interface {
	...
	/// Used to validate transaction pin. Pass in a ValidateTransactionPinRequest and the default response would be returned
	ValidateTransactionPin(context.Context, *ValidateTransactionPinRequest) (*types.DefaultResponse, error)
}
...
func (*UnimplementedAuthServiceServer) ValidateTransactionPin(context.Context, *ValidateTransactionPinRequest) (*types.DefaultResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ValidateTransactionPin not implemented")
}
...
func _AuthService_ValidateTransactionPin_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ValidateTransactionPinRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthServiceServer).ValidateTransactionPin(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/auth.AuthService/ValidateTransactionPin",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).ValidateTransactionPin(ctx, req.(*ValidateTransactionPinRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _AuthService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ValidateTransactionPin",
			Handler:    _AuthService_ValidateTransactionPin_Handler,
		},
	},
