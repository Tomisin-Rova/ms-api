...
type UpdateFeesRequest struct {
	...
	TransactionTypeId string                 `protobuf:"bytes,1,opt,name=transaction_type_id,json=transactionTypeId,proto3" json:"transaction_type_id,omitempty"`
	Type              types.Fee_FeeTypes     `protobuf:"varint,2,opt,name=type,proto3,enum=types.Fee_FeeTypes" json:"type,omitempty"`
	Boundaries        []*types.FeeBoundaries `protobuf:"bytes,3,rep,name=boundaries,proto3" json:"boundaries,omitempty"`
}
...
func (x *UpdateFeesRequest) GetTransactionTypeId() string {
	if x != nil {
		return x.TransactionTypeId
	}
	return ""
...
func (x *UpdateFeesRequest) GetType() types.Fee_FeeTypes {
	if x != nil {
		return x.Type
	}
	return types.Fee_FeeTypes(0)
}

func (x *UpdateFeesRequest) GetBoundaries() []*types.FeeBoundaries {
	if x != nil {
		return x.Boundaries
	}
	return nil
...
type UpdateFeesRequests struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Fees []*UpdateFeesRequest `protobuf:"bytes,1,rep,name=fees,proto3" json:"fees,omitempty"`
}

func (x *UpdateFeesRequests) Reset() {
	*x = UpdateFeesRequests{}
	if protoimpl.UnsafeEnabled {
...
func (x *UpdateFeesRequests) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UpdateFeesRequests) ProtoMessage() {}

func (x *UpdateFeesRequests) ProtoReflect() protoreflect.Message {
	mi := &file_pricing_proto_msgTypes[8]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UpdateFeesRequests.ProtoReflect.Descriptor instead.
func (*UpdateFeesRequests) Descriptor() ([]byte, []int) {
	return file_pricing_proto_rawDescGZIP(), []int{8}
}

func (x *UpdateFeesRequests) GetFees() []*UpdateFeesRequest {
	if x != nil {
		return x.Fees
	}
	return nil
...
type UpdateFXRequest struct {
	...
	BaseCurrencyId string  `protobuf:"bytes,1,opt,name=base_currency_id,json=baseCurrencyId,proto3" json:"base_currency_id,omitempty"`
	CurrencyId     string  `protobuf:"bytes,2,opt,name=currency_id,json=currencyId,proto3" json:"currency_id,omitempty"`
	SalePrice      float32 `protobuf:"fixed32,3,opt,name=sale_price,json=salePrice,proto3" json:"sale_price,omitempty"`
...
func (x *UpdateFXRequest) GetBaseCurrencyId() string {
	if x != nil {
...
func (x *UpdateFXRequest) GetCurrencyId() string {
	if x != nil {
		return x.CurrencyId
	}
	return ""
...
func (x *UpdateFXRequest) GetSalePrice() float32 {
	if x != nil {
		return x.SalePrice
	}
	return 0
...
func (x *UpdateFXRequest) GetBuyPrice() float32 {
	if x != nil {
		return x.BuyPrice
	}
	return 0
...
var file_pricing_proto_rawDesc = []byte{
	...
	0x61, 0x6e, 0x67, 0x65, 0x52, 0x61, 0x74, 0x65, 0x22, 0xa2, 0x01, 0x0a, 0x11, 0x55, 0x70, 0x64,
	0x61, 0x74, 0x65, 0x46, 0x65, 0x65, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x2e,
	0x0a, 0x13, 0x74, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x74, 0x79,
	0x70, 0x65, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x11, 0x74, 0x72, 0x61,
	...
	,
	...
	,
...
var file_pricing_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_pricing_proto_goTypes = []interface{}{
	...
	(*UpdateFeesRequest)(nil),       // 7: pricing.UpdateFeesRequest
	(*UpdateFeesRequests)(nil),      // 8: pricing.UpdateFeesRequests
	(*UpdateFXRequest)(nil),         // 9: pricing.UpdateFXRequest
	(*types.Currency)(nil),          // 10: types.Currency
	(*types.PaginationInfo)(nil),    // 11: types.PaginationInfo
	(*types.Fee)(nil),               // 12: types.Fee
	(*types.ExchangeRate)(nil),      // 13: types.ExchangeRate
	(types.Fee_FeeTypes)(0),         // 14: types.Fee.FeeTypes
	(*types.FeeBoundaries)(nil),     // 15: types.FeeBoundaries
	(*types.DefaultResponse)(nil),   // 16: types.DefaultResponse
}
var file_pricing_proto_depIdxs = []int32{
	10, // 0: pricing.GetCurrenciesResponse.nodes:type_name -> types.Currency
	11, // 1: pricing.GetCurrenciesResponse.pagination_info:type_name -> types.PaginationInfo
	12, // 2: pricing.GetFeesResponse.fees:type_name -> types.Fee
	13, // 3: pricing.GetExchangeRateResponse.exchange_rate:type_name -> types.ExchangeRate
	14, // 4: pricing.UpdateFeesRequest.type:type_name -> types.Fee.FeeTypes
	15, // 5: pricing.UpdateFeesRequest.boundaries:type_name -> types.FeeBoundaries
	7,  // 6: pricing.UpdateFeesRequests.fees:type_name -> pricing.UpdateFeesRequest
	0,  // 7: pricing.PricingService.GetCurrency:input_type -> pricing.GetCurrencyRequest
	1,  // 8: pricing.PricingService.GetCurrencies:input_type -> pricing.GetCurrenciesRequest
	3,  // 9: pricing.PricingService.GetFees:input_type -> pricing.GetFeesRequest
	5,  // 10: pricing.PricingService.GetExchangeRate:input_type -> pricing.GetExchangeRateRequest
	9,  // 11: pricing.PricingService.UpdateFX:input_type -> pricing.UpdateFXRequest
	8,  // 12: pricing.PricingService.UpdateFees:input_type -> pricing.UpdateFeesRequests
	10, // 13: pricing.PricingService.GetCurrency:output_type -> types.Currency
	2,  // 14: pricing.PricingService.GetCurrencies:output_type -> pricing.GetCurrenciesResponse
	4,  // 15: pricing.PricingService.GetFees:output_type -> pricing.GetFeesResponse
	6,  // 16: pricing.PricingService.GetExchangeRate:output_type -> pricing.GetExchangeRateResponse
	16, // 17: pricing.PricingService.UpdateFX:output_type -> types.DefaultResponse
	16, // 18: pricing.PricingService.UpdateFees:output_type -> types.DefaultResponse
...
func file_pricing_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_pricing_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
		...
		file_pricing_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*UpdateFeesRequests); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_pricing_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
...
type PricingServiceClient interface {
	...
	UpdateFX(ctx context.Context, in *UpdateFXRequest, opts ...grpc.CallOption) (*types.DefaultResponse, error)
	UpdateFees(ctx context.Context, in *UpdateFeesRequests, opts ...grpc.CallOption) (*types.DefaultResponse, error)
}
...
func (c *pricingServiceClient) UpdateFX(ctx context.Context, in *UpdateFXRequest, opts ...grpc.CallOption) (*types.DefaultResponse, error) {
	out := new(types.DefaultResponse)
	err := c.cc.Invoke(ctx, "/pricing.PricingService/UpdateFX", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *pricingServiceClient) UpdateFees(ctx context.Context, in *UpdateFeesRequests, opts ...grpc.CallOption) (*types.DefaultResponse, error) {
	out := new(types.DefaultResponse)
	err := c.cc.Invoke(ctx, "/pricing.PricingService/UpdateFees", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PricingServiceServer interface {
	...
	UpdateFX(context.Context, *UpdateFXRequest) (*types.DefaultResponse, error)
	UpdateFees(context.Context, *UpdateFeesRequests) (*types.DefaultResponse, error)
}
...
func (*UnimplementedPricingServiceServer) UpdateFX(context.Context, *UpdateFXRequest) (*types.DefaultResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateFX not implemented")
}
func (*UnimplementedPricingServiceServer) UpdateFees(context.Context, *UpdateFeesRequests) (*types.DefaultResponse, error) {
...
func _PricingService_UpdateFX_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateFXRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PricingServiceServer).UpdateFX(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pricing.PricingService/UpdateFX",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PricingServiceServer).UpdateFX(ctx, req.(*UpdateFXRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _PricingService_UpdateFees_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateFeesRequests)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PricingServiceServer).UpdateFees(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pricing.PricingService/UpdateFees",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PricingServiceServer).UpdateFees(ctx, req.(*UpdateFeesRequests))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _PricingService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "UpdateFX",
			Handler:    _PricingService_UpdateFX_Handler,
		},
		{
			MethodName: "UpdateFees",
			Handler:    _PricingService_UpdateFees_Handler,
		},
	},
