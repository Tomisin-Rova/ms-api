...
var file_types_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x12, 0x1a, 0x0a, 0x08, 0x72, 0x65, 0x70, 0x6f, 0x72,
...
var file_types_proto_depIdxs = []int32{
	...
	15, // 13: types.Kyc.applicant:type_name -> types.Applicant
	66, // 14: types.Aml.reports:type_name -> google.protobuf.Any
	3,  // 15: types.Applicant.address:type_name -> types.Address
	19, // 16: types.Payee.accounts:type_name -> types.payeeAccount
	17, // 17: types.Payees.payee:type_name -> types.Payee
	23, // 18: types.Identity.organisation:type_name -> types.Organisation
	4,  // 19: types.Identity.devices:type_name -> types.Device
	22, // 20: types.Identity.credentials:type_name -> types.Credentials
	1,  // 21: types.ExtendedIdentity.owner:type_name -> types.Person
	23, // 22: types.ExtendedIdentity.organisation:type_name -> types.Organisation
	4,  // 23: types.ExtendedIdentity.devices:type_name -> types.Device
	22, // 24: types.ExtendedIdentity.credentials:type_name -> types.Credentials
	3,  // 25: types.Organisation.addresses:type_name -> types.Address
	24, // 26: types.Organisation.location:type_name -> types.OrgLocation
	25, // 27: types.Organisation.industries:type_name -> types.Industry
	26, // 28: types.Organisation.social:type_name -> types.Social
	27, // 29: types.Organisation.image_assets:type_name -> types.ImageAssets
	20, // 30: types.Organisation.identities:type_name -> types.Identity
	33, // 31: types.Account.accountData:type_name -> types.AccountData
	59, // 32: types.Account.transactions:type_name -> types.Transaction
	32, // 33: types.Account.tags:type_name -> types.Tag
	34, // 34: types.Account.AccountDetails:type_name -> types.AccountDetails
	35, // 35: types.AccountData.accruedAmounts:type_name -> types.AccruedAmounts
	36, // 36: types.AccountData.balances:type_name -> types.Balances
	37, // 37: types.AccountData.interestSettings:type_name -> types.InterestSettings
	40, // 38: types.AccountData.internalControls:type_name -> types.InternalControls
	41, // 39: types.AccountData.overdraftInterestSettings:type_name -> types.OverdraftInterestSettings
	43, // 40: types.AccountData.overdraftSettings:type_name -> types.OverdraftSettings
	38, // 41: types.InterestSettings.interestPaymentSettings:type_name -> types.InterestPaymentSettings
	42, // 42: types.InterestSettings.interestRateSettings:type_name -> types.InterestRateSettings
	56, // 43: types.InterestSettings.interestRate:type_name -> types.InterestRate
	55, // 44: types.InterestSettings.rateTiers:type_name -> types.RateTiers
	39, // 45: types.InterestPaymentSettings.interestPaymentDates:type_name -> types.InterestPaymentDate
	42, // 46: types.OverdraftInterestSettings.interestRateSettings:type_name -> types.InterestRateSettings
	44, // 47: types.InterestRateSettings.interestRateTiers:type_name -> types.InterestRateTier
	46, // 48: types.Product.details:type_name -> types.ProductDetails
	50, // 49: types.ProductDetails.productTemplates:type_name -> types.ProductTemplates
	49, // 50: types.ProductDetails.productFees:type_name -> types.ProductFees
	47, // 51: types.ProductDetails.productControl:type_name -> types.ProductControl
	51, // 52: types.ProductDetails.productMaturity:type_name -> types.ProductMaturity
	52, // 53: types.ProductDetails.overdraftSetting:type_name -> types.OverdraftSetting
	53, // 54: types.ProductDetails.interestSetting:type_name -> types.ProductInterestSetting
	57, // 55: types.ProductDetails.productSetting:type_name -> types.ProductSetting
	48, // 56: types.ProductControl.openingBalance:type_name -> types.OpeningBalance
	58, // 57: types.ProductFees.accountingRules:type_name -> types.AccountingRules
	37, // 58: types.OverdraftSetting.interestSettings:type_name -> types.InterestSettings
	54, // 59: types.ProductInterestSetting.rateSetting:type_name -> types.RateSetting
	39, // 60: types.ProductInterestSetting.interestPaymentDates:type_name -> types.InterestPaymentDate
	55, // 61: types.RateSetting.rateTiers:type_name -> types.RateTiers
	56, // 62: types.RateSetting.interestRate:type_name -> types.InterestRate
	58, // 63: types.ProductSetting.accountingRules:type_name -> types.AccountingRules
	31, // 64: types.Transaction.account:type_name -> types.Account
	60, // 65: types.Transaction.transactionData:type_name -> types.TransactionData
	63, // 66: types.TransactionData.transferDetails:type_name -> types.TransferDetails
	64, // 67: types.TransactionData.fees:type_name -> types.TransactionFee
	62, // 68: types.TransactionData.affectedAmounts:type_name -> types.AffectedAmounts
	61, // 69: types.TransactionData.accountBalances:type_name -> types.AccountBalances
	5,  // 70: types.Staff.emails:type_name -> types.Email
	6,  // 71: types.Staff.phones:type_name -> types.PhoneNumber
	21, // 72: types.Staff.identities:type_name -> types.ExtendedIdentity
