...
//go:generate genny -in=connection_template.go -out=gen_payment_lookup.go gen "Name=PaymentLookup NodeType=*types.Payment EdgeType=types.PaymentEdge ConnectionType=types.PaymentConnection"
