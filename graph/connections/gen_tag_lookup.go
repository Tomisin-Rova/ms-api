...
// create an Edge.
type TagLookupEdgeMaker func(value *types.Tag, offset int) Edge

// TagLookupConMaker define a function that create a types.TagConnection
type TagLookupConMaker func(
	edges []*types.TagEdge,
	nodes []*types.Tag,
	info *types.PageInfo,
	totalCount int) (*types.TagConnection, error)

// TagLookupCon will paginate a source according to the input of a relay connection
func TagLookupCon(source []*types.Tag, edgeMaker TagLookupEdgeMaker, conMaker TagLookupConMaker, input models.ConnectionInput) (*types.TagConnection, error) {
	var nodes []*types.Tag
