...
func (m *MockPaymentServiceClient) CreateTransfer(ctx context.Context, in *payment.CreateTransferRequest, opts ...grpc.CallOption) (*types.Transaction, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{ctx, in}
	for _, a := range opts {
		varargs = append(varargs, a)
...
// CreateTransfer mocks base method
func (m *MockPaymentServiceServer) CreateTransfer(arg0 context.Context, arg1 *payment.CreateTransferRequest) (*types.Transaction, error) {
	m.ctrl.T.Helper()
