...
// SetDevicePreference provides a mock function with given fields: ctx, in, opts
func (_m *IdentityServiceClient) SetDevicePreference(ctx context.Context, in *identityService.SetDevicePreferenceRequest, opts ...grpc.CallOption) (*types.Response, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	var r0 *types.Response
	if rf, ok := ret.Get(0).(func(context.Context, *identityService.SetDevicePreferenceRequest, ...grpc.CallOption) *types.Response); ok {
		r0 = rf(ctx, in, opts...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*types.Response)
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, *identityService.SetDevicePreferenceRequest, ...grpc.CallOption) error); ok {
		r1 = rf(ctx, in, opts...)
	} else {
		r1 = ret.Error(1)
	}
