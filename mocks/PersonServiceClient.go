...
// GetStaffById provides a mock function with given fields: ctx, in, opts
func (_m *PersonServiceClient) GetStaffById(ctx context.Context, in *personService.StaffRequest, opts ...grpc.CallOption) (*types.Staff, error) {
	...
	var r0 *types.Staff
	if rf, ok := ret.Get(0).(func(context.Context, *personService.StaffRequest, ...grpc.CallOption) *types.Staff); ok {
		r0 = rf(ctx, in, opts...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*types.Staff)
		}
	}

	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, *personService.StaffRequest, ...grpc.CallOption) error); ok {
		r1 = rf(ctx, in, opts...)
	} else {
		r1 = ret.Error(1)
	}
