...
// GetAccountsStream provides a mock function with given fields: ctx, in, opts
func (_m *AccountServiceClient) GetAccountsStream(ctx context.Context, in *accountService.GetAccountsRequest, opts ...grpc.CallOption) (accountService.AccountService_GetAccountsStreamClient, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	var r0 accountService.AccountService_GetAccountsStreamClient
	if rf, ok := ret.Get(0).(func(context.Context, *accountService.GetAccountsRequest, ...grpc.CallOption) accountService.AccountService_GetAccountsStreamClient); ok {
		r0 = rf(ctx, in, opts...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(accountService.AccountService_GetAccountsStreamClient)
		}
	}
